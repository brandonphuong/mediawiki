...
$messages['de'] = array(
	...
	'tasklistnoprojects' => "Fehler: Es sieht so aus, als wenn der Parameter '''<code>\$wgUseProjects</code>''' zwar aktiviert, hingegen die Seite [[MediaWiki:TodoTasksValidProjects]] nicht erstellt wurde. Siehe die [https://www.mediawiki.org/wiki/Extension:Todo_Tasks#Step_8 Installationsanweisungen] für weitere Einzelheiten.",
	'tasklistemailbody' => ',
...
$messages['frp'] = array(
	...
	'tasklistincorrectuser' => 'Nom d’usanciér fôx',
...
$messages['ja'] = array(
	'tasklist' => '課題一覧',
	'tasklist-parser-desc' => '課題割り当てのための <nowiki>{{#todo:}}</nowiki> パーサー関数を追加する',
...
$messages['ka'] = array(
	...
	'tasklistbyproject' => 'დავალებების სია პროექტების მიხედვით',
	'tasklistunknownproject' => 'უცნობი პროექტი',
	'tasklistunspecuser' => 'უცნობი მომხმარებელი',
	'tasklistincorrectuser' => 'არასწორი მომხმარებლის სახელი',
	'tasklistemail' => 'ძვირფასო %s',
	'tasklistemailsubject' => '[%s] დავალებების სიის შეცვლა',
	'tasklistmytasks' => 'ჩემი დავალებები',
	'tasklistbyprojname' => "'''%s'''-თვის დანიშნული დავალებები",
	'tasklistchooseproj' => 'აირჩიეთ პროექტი:',
	'tasklistprojdisp' => 'ჩვენება',
	'tasklistbyname' => '== დავალებების სია %s-თვის ==',
);
...
$messages['ko'] = array(
	'tasklist' => '작업 목록',
	'tasklist-parser-desc' => '작업을 할당하기 위해 <nowiki>{{#todo:}}</nowiki> 파서 함수를 추가',
	...
	'tasklistemail' => '%s로부터',
	'tasklistemailsubject' => '[%s] 작업 목록 바뀜',
...
올바른 프로젝트 목록에 대해서는 [[MediaWiki:TodoTasksValidProjects]]를 참고하십시오.",
	...
	'tasklistnowguseprojects' => '$wgUseProjects를 "false"로 설정했으므로 이 문서를 사용할 수 없습니다.',
	'tasklistnoprojects' => "오류: '''\$wgUseProjects'''를 활성화한 것으로 보이지만 [[MediaWiki:TodoTasksValidProjects]]를 만들 수 없었습니다. 자세한 사항에 대해서는 [http://www.mediawiki.org/wiki/Extension:Todo_Tasks#Step_8 Installation Instructions]을 참고하십시오.",
	'tasklistemailbody' => ',
...
Fir eng Lëschtvun den disponibele Projeten, kuckt w.e.g. [[MediaWiki:TodoTasksValidProjects]].",
	...
	'tasklistnoprojects' => "FEELER: Et gesäit aus wéi wann Dir '''\$wgUseProjects''' ageschalt hätt, mä Dir hutt [[MediaWiki:TodoTasksValidProjects]] net erstallt. Kuckt [http://www.mediawiki.org/wiki/Extension:Todo_Tasks#Step_8 Installatiouns Instructiounen] fir méi Informatiounen.",
	'tasklistemailbody' => ',
...
$messages['ps'] = array(
	...
	'tasklistunknownproject' => 'ناڅرګنده پروژه',
...
$messages['ro'] = array(
	...
	'tasklistbyprojname' => "Sarcini atribuite pentru '''%s'''",
	'tasklistchooseproj' => 'Alegeți proiectul:',
	'tasklistprojdisp' => 'Afișare',
	'tasklistbyname' => '== Lista obiectivelor de îndeplinit pentru %s ==',
);
 ...
 */
$messages['si'] = array(
	'tasklist' => 'කාර්යයන් ලැයිස්තුව',
	'tasklistunknownproject' => 'නොදන්නා ව්‍යාපෘතිය',
	'tasklistincorrectuser' => 'වැරදි පරිශීලක නාමය',
	'tasklistemail' => 'හිතවත් %s',
	'tasklistmytasks' => 'මගේ කාර්යයන්',
	'tasklistchooseproj' => 'ව්‍යාපෘතිය තෝරාගන්න:',
	'tasklistprojdisp' => 'පෙන්වීම',
);
...
$messages['sk'] = array(
	...
	'tasklistnowguseprojects' => 'Máte $wgUseProjects nastavené na „false“, takže túto stránku nemôžete používať.',
...
$messages['ta'] = array(
	...
	'tasklistmytasks' => 'என் பணிகள்',
	'tasklistchooseproj' => 'திட்டத்தை தேர்வுசெய்:',
);
 ...
 */
$messages['ur'] = array(
	'tasklistunknownproject' => 'نامعلوم پروجیکٹ',
	'tasklistincorrectuser' => 'غلط صارف کا نام',
	'tasklistmytasks' => 'میرے کام',
	'tasklistchooseproj' => 'پروجیکٹ کو منتخب کریں:',
	'tasklistprojdisp' => 'ڈسپلے',
);
